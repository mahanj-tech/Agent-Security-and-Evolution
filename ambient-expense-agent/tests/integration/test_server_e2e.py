...
def test_chat_stream(server_fixture: subprocess.Popen[str]) -> None:
    ...
    data = {
        ...
        "new_message": {
            ...
            "parts": [
                {
                    "text": '{"data": "eyJhbW91bnQiOiA1MC4wLCAic3VibWl0dGVyIjogImFsaWNlQGV4YW1wbGUuY29tIiwgImNhdGVnb3J5IjogInRyYXZlbCIsICJkZXNjcmlwdGlvbiI6ICJVYmVyIHJpZGUiLCAiZGF0ZSI6ICIyMDI2LTA2LTIyIn0="}'
                }
            ],
        },
        "streaming": True,
