...
async def test_agent_stream_query(agent_app: AgentEngineApp) -> None:
    ...
    message = '{"data": "eyJhbW91bnQiOiA1MC4wLCAic3VibWl0dGVyIjogImFsaWNlQGV4YW1wbGUuY29tIiwgImNhdGVnb3J5IjogInRyYXZlbCIsICJkZXNjcmlwdGlvbiI6ICJVYmVyIHJpZGUiLCAiZGF0ZSI6ICIyMDI2LTA2LTIyIn0="}'
    events = []
