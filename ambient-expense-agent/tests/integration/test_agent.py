...
def test_agent_stream() -> None:
    ...
    # Send a low-value expense report that does not require LLM calls (auto-approved)
    ...
    message = types.Content(role="user", parts=[types.Part.from_text(text=raw_message)])
